...
static void draw_top(lv_obj_t *widget, lv_color_t cbuf[], const struct status_state *state) {
    ...
    // Draw connection status on the left (matches LHS zmk-nice-oled bluetooth icon)
    ...
    // Draw battery level on the right (matches LHS zmk-nice-oled digital percentage)
